# Operator Quickstart — Community Satellite Telecommunications Operations

Shortest path from clone to a verified local dry-run for **ISIC 6130** (`cloud-itonami-isic-6130`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6130.git
cd cloud-itonami-isic-6130
```
...
- Blueprint governor key: `satellite-network-governor`
- Likely source path: `satcom.governor.cljc`
